...
class AlgorithmManager:
    ...
    def execute_algorithm(self, algorithm_info:AlgorithmInfo, note_dict):
        ...
        if algorithm_info.algorithm_type == Algorithm.SIGNATURE_MODE_AXIS:
            ...
            result_note, result_mode = self.tonal_profiles_utility.decide_between_parallel(sample_vector=note_dict, tonation_note=tonation_note, profile=algorithm_info.profile)
        elif algorithm_info.algorithm_type == Algorithm.CLASSIC_TONAL_PROFILES:
            result_note, result_mode = self.tonal_profiles_utility.classic_tonal_profiles_algorithm(sample_vector=note_dict, profile=algorithm_info.profile)

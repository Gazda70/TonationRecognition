...
class AlgorithmManager:
    ...
    def execute_algorithm(self, algorithm_info: AlgorithmInfo, note_dict):
        ...
        if algorithm_info.algorithm_type.name == Algorithm.SIGNATURE_MODE_AXIS.name:
        ...
        elif algorithm_info.algorithm_type.name == Algorithm.SIGNATURE_TONAL_PROFILES.name:
            signature, same_axes = self.basic_signature_algorithm(note_dict)
        ...
        elif algorithm_info.algorithm_type.name == Algorithm.CLASSIC_TONAL_PROFILES.name:
    ...
    def basic_signature_algorithm(self, notes_dict):
        ...
        same_axes = self.signature_utility.calculate_mdasf(signature)
        return signature, same_axes

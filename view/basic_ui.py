...
class UI_MainPage(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.algorithm_type_dropdown.setGeometry(QtCore.QRect(530, 60, 271, 51))
        font = QtGui.QFont()
        ...
        self.tonal_profiles_type.setGeometry(QtCore.QRect(1130, 60, 271, 51))
        ...
        self.sample_calculation_mode.setGeometry(QtCore.QRect(830, 60, 271, 51))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.min_rhythmic_value.setGeometry(QtCore.QRect(540, 545, 211, 21))
        ...
        self.label.setGeometry(QtCore.QRect(540, 500, 221, 41))
